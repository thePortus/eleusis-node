(function() {
  ...
  angular.module('eleusis.inscriptions')
    .controller('InscriptionDetailsCtrl', inscriptionDetailsCtrl);

  function inscriptionDetailsCtrl(
    $stateParams, Interface, Stats, InscriptionDetails, InscriptionHonorsDetails, InscriptionInstitutionsDetails, InscriptionPeopleDetails, InscriptionNetwork
  ) {
    ...
    function initialize() {
      ...
      vm.details_table = new InscriptionDetails($stateParams.idNum);
      new InscriptionHonorsDetails($stateParams.idNum).get(get_honors_cb);
      new InscriptionInstitutionsDetails($stateParams.idNum).get(get_institutions_cb);
      new InscriptionPeopleDetails($stateParams.idNum).get(get_people_cb);
      vm.networkfactory = new InscriptionNetwork(vm.parameters.idNum);
    ...
    function back() {
      ...
      Interface.go('inscriptions.list');
    }
  }
